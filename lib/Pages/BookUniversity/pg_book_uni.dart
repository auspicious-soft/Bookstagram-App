...
class PgBookUni extends StatefulWidget {
  const PgBookUni({super.key});

  @override
  State<PgBookUni> createState() => _PgBookUniState();
}

class _PgBookUniState extends State<PgBookUni> {
  @override
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  Label(
                    txt: AppLocalization.of(context).translate('skillscourses'),

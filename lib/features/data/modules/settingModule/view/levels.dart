                        ...
                        () => SingleChildScrollView(
                          child: GridView.builder(
                            ...
                            itemCount: controller
                                    .achievementsResponse.value?.data?.length ??
                                0,
                            itemBuilder: (context, index) {
                              final achievement = controller
                                  .achievementsResponse.value?.data?[index];
                              return Column(
                                children: [
                                  Image.asset(
                                    achievement?.badge == "Saint"
                                        ...
                                        : achievement?.badge == "Hakim"
                                            ? achievement?.achieved == false
                                                ? AppAssets.Hakimbadgeblank
                                                : AppAssets.Hakimbadge
                                            : achievement?.badge == "Genius"
                                                ? achievement?.achieved == false
                                                    ? AppAssets.Geniusbadgeblank
                                                    : AppAssets.Geniusbadge
                                                : achievement?.badge ==
                                                        "Teacher"

...
class BookMastersController extends GetxController {
  ...
  Future<BookStudyModel> getListBooks() async {
    try {
      ...
      String uri =
          '${AppConfig.baseUrl}${AppConfig.getBookMasterHome}?language=${Uri.encodeComponent(selectedLanguage == "en" ? "eng" : selectedLanguage == "ru" ? "rus" : "kaz")}';

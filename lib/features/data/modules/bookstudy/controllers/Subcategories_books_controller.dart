...
class SubcategoriesBooksController extends GetxController {
  ...
  Future<SubCategoriesBookResponse> getCollectionById({String? id}) async {
    try {
      ...
      String uri =
          '${AppConfig.baseUrl}api/user/sub-categories/$id?sorting=${filter.value == AppLocalization.of(Get.context!).translate('alphabetically') ? "alphabetically" : filter.value == AppLocalization.of(Get.context!).translate('byrating') ? "rating" : filter.value == AppLocalization.of(Get.context!).translate('bynovelty') ? "newest" : "default"}';
  ...
  void onInit() {
    ...
    if (Get.arguments != null) {
      ...
      if (id.value != null && id.isNotEmpty) {

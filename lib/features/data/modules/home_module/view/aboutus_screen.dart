...
final List<Map<String, String>> webLinksEnglish = [
  ...
  {
    'title': 'conditionsuse',
    'url': 'https://bookstagram.kz/en/conditions-of-use'
  },
    ...
    return Scaffold(
      ...
      body: AnnotatedRegion<SystemUiOverlayStyle>(
        value: SystemUiOverlayStyle(
          statusBarColor: AppColors.background, // Set staatus bar
          statusBarIconBrightness: Brightness.dark, // Dark icons for status bar
          systemNavigationBarColor:
              AppColors.background, // Match nav bar to background
        ),
        child: Column(

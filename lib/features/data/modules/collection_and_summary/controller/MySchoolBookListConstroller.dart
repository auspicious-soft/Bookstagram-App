...
import '../models/BookSchoolBookListModel.dart';
import '../models/favourite_books_responseModel.dart';

class Myschoolbooklistconstroller extends GetxController {
  // Reactive list to manage like/unlike state for each book
  // var likeStates = <bool>[false, false, false].obs; // Initialize for 3 books
  final Rx<Bookschoolbooklistmodel?> collectiondata =
      Rx<Bookschoolbooklistmodel?>(null);
  ...
  Future<Bookschoolbooklistmodel> getMyFavourite() async {
    try {
      ...
      String uri = '${AppConfig.baseUrl}${AppConfig.BookSchoolBooksEndPoint}';
      ...
      if (response.statusCode == 200) {
        ...
        return Bookschoolbooklistmodel.fromJson(jsonBody);
      } else {

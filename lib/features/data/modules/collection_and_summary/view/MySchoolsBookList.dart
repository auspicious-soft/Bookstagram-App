...
class Myschoolsbooklist extends GetView<Myschoolbooklistconstroller> {
  const Myschoolsbooklist({super.key});
                                                ...
                                                children: [
                                                  ...
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Label(
                                                        txt:
                                                            "${controller.getBookTitle(name: controller?.collectiondata?.value?.data?[index]?.name)}",
                                                        type:
                                                            TextTypes.f_17_500,
                                                      ),
                                                      Label(
                                                        txt:
                                                            "${controller.getBookTitle(name: controller?.collectiondata?.value?.data?[index]?.authorId?.first?.name)}",
                                                        type:
                                                            TextTypes.f_13_400,
                                                        forceColor:
                                                            AppColors.resnd,
                                                      ...
                                                      Label(
                                                        txt:
                                                            "${controller?.collectiondata?.value?.data?[index]?.genre?.first}",
                                                        type:
                                                            TextTypes.f_13_400,
                                                        forceColor:
                                                            AppColors.resnd,
                                                ...
                                                children: [
                                                  Row(
                                                    children: [
                                                      ...
                                                      Label(
                                                        txt:
                                                            "${controller?.collectiondata?.value?.data?[index]?.averageRating?.toStringAsFixed(1) ?? 0.0}",
                                                        type:
                                                            TextTypes.f_11_500,
                                                      ),
                                                      padHorizontal(8),

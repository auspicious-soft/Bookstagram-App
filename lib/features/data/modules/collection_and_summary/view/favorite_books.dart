...
class PgFavoriteBooks extends GetView<PgFavoriteBooksController> {
  const PgFavoriteBooks({super.key});
                                                ...
                                                children: [
                                                  ...
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Label(
                                                        txt:
                                                            "${controller.getBookTitle(name: controller?.collectiondata?.value?.data?[index]?.productId?.name)}",
                                                        type:
                                                            TextTypes.f_17_500,
                                                      ),
                                                      Label(
                                                        txt:
                                                            "${controller.getBookTitle(name: controller?.collectiondata?.value?.data?[index]?.productId?.authorId?.first?.name)}",
                                                        type:
                                                            TextTypes.f_13_400,
                                                        forceColor:
                                                            AppColors.resnd,
                                                      ...
                                                      Label(
                                                        txt:
                                                            "${controller?.collectiondata?.value?.data?[index]?.productId?.genre?.first}",
                                                        type:
                                                            TextTypes.f_13_400,
                                                        forceColor:
                                                            AppColors.resnd,
                                                ...
                                                children: [
                                                  Row(
                                                    children: [
                                                      ...
                                                      Label(
                                                        txt:
                                                            "${controller?.collectiondata?.value?.data?[index]?.productId?.averageRating?.toStringAsFixed(1) ?? 0.0}",
                                                        type:
                                                            TextTypes.f_11_500,
                                                      ),
                                                      padHorizontal(8),

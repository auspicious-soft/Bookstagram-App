...
class PgCompletedBooks extends StatefulWidget {
  const PgCompletedBooks({super.key});

  @override
  State<PgCompletedBooks> createState() => _PgCompletedBooksState();
}

class _PgCompletedBooksState extends State<PgCompletedBooks> {
  int selectedIndex = 0;

...
class PgFavoriteBooks extends StatefulWidget {
  const PgFavoriteBooks({super.key});

  @override
  State<PgFavoriteBooks> createState() => _PgFavoriteBooksState();
}

class _PgFavoriteBooksState extends State<PgFavoriteBooks> {
  int selectedIndex = 0;
